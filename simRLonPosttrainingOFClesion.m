% Experiment 2 - Marios Panayi, Mehdi Khamassi, Simon Killcross (2021)
% post-training lOFC muscimol inactivation

%% PARAMETERS
ofclesion = false;
nbSession = 17; % 17 days
...
for nt=1:nbTrial
    ...
    if (ofclesion)&&(nt > (16*11))&&(nt < (16*16))
...
%         probaMBMF(nt+1,3) = min(1,probaMBMF(nt+1,3) + infusionLevel/200); % proba of choosing EXP system
%         probaMBMF(nt+1,1) = (1 - probaMBMF(nt+1,3)) / 2; % proba of choosing MB system
%         probaMBMF(nt+1,2) = (1 - probaMBMF(nt+1,3)) / 2; % proba of choosing MF system
