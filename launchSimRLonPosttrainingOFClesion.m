%% launch simRLonPosttrainingOFClesion
nbExperiments = 1000;
...
xlabel('Trial Number')
legend('MB','MF','EXP','Location','north')
subplot(2,1,2)
plot(mean(totalY')'-1,'k','LineWidth',2)
ylabel('Probability of Magazine Entry')
xlabel('Trial Number')
legend('Saline','Muscimol','Lesion','Location','south')
